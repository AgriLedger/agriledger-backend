                ...
                <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td class="content-cell">
                      ...
                      <p>You recently requested to reset your password for your AgriLedger account. Use the button below to reset it. <strong>This password reset is only valid for the next 15 minutes.</strong></p>
                      <!-- Action -->
                              ...
                              <tr>
                                <td align="center">
                                  <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td>
                                        <a href="${url}" class="button button--green">Reset your password</a>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
